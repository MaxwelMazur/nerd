-- responsavel por carregar o gerenciador de plugins
-- atualmente usando Packer https://github.com/wbthomason/packer.nvim
...
local present, plugins = pcall(require, "plugins")
if not present then
    return
end
